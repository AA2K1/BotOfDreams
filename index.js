...
client.on("message", async message => {
  client.emojis.cache.set("pog", "769546554247741451");
  client.emojis.cache.set("poggers", "769546719976226836");
  const pog = client.emojis.cache.get("769546554247741451");
  const poggers = client.emojis.cache.get("769546719976226836");
        ...
        Money.findOne(
          ...
          (err, money) => {
            ...
            if (!money) {
              ...
              message.channel.send(`\`Congratulations ${client.users.cache.get(money.userID).username}! You just got ${coinAmt} coins!\``)
